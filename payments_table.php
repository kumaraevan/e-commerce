...
$sql = "SELECT PaymentID, OrderID, Date FROM payment $whereClause ORDER BY PaymentID ASC";
...
if (!$result) {
    $feedback_message = "Error retrieving payments: " . htmlspecialchars($conn->error);
}
?>
...
<body class="bg-gray-100 font-sans">
    ...
    <div class="container mx-auto px-4 pt-5">
        <h2 class="text-3xl font-semibold text-gray-800 mb-6">Manage Payments</h2>

        <!-- Search bar -->
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="GET" class="mb-4">
            <div class="flex items-center">
                <input type="text" name="search" value="<?php echo htmlspecialchars($search); ?>" placeholder="Search payments" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
